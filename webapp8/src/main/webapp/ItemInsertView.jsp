...
<input type="text" name="itemname" placeholder="商品名" required><br>
<input type="number" name="price" placeholder="価格" required><br>
<textarea name="detail" placeholder="説明"></textarea><br>
<input type="number" step="0.1" name="rating" placeholder="評価" required><br>
<input type="text" name="image" placeholder="画像" required><br>
